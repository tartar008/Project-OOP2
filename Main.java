...
public class Main {
    ...
    private static void handleOnlineBooking(ReserveRoom reserveRooms) {
        ...
        while (confirmBooking) {
            List<src.rooms.TransectionRoom> availableRooms = reserveRooms.getAvailableRooms(checkInDate, checkOutDate);
            ...
            if (completeBooking.equalsIgnoreCase("Y")) {
                ...
                // availableRoomsAfterBooking.size());
            } else {
    ...
    private static void displayAvailableRooms(List<TransectionRoom> standards, List<TransectionRoom> family,
        ...
        System.out.println("[ 1 ] Available Standard Rooms: " + standards.size());
        System.out.println("[ 2 ] Available Family Rooms: " + family.size());
        System.out.println("[ 3 ] Available Honeymoon Rooms: " + honeymoon.size());
    }
